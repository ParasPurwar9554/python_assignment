...
#img = cv2.imread("D:/My Python Projects/Open CV/highway.jpg", cv2.IMREAD_COLOR)
...
pts_polygon = np.array([[100, 50], [100, 300], [500, 300], [500, 50]], np.int32)
cv2.polylines(img, [pts_polygon], True, (0, 255, 255), 3)

font = cv2.FONT_HERSHEY_DUPLEX
cv2.putText(img, 'HELLO!', (10, 50), font, 2, (200, 255, 255), 3, cv2.LINE_AA)
